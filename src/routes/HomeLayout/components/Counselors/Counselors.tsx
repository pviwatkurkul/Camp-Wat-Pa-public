...
import CounselorsImage from "../../../../assets/images/Counselors.png";
        ...
        <Container className="h-100 bg-secondaryLight" maxWidth="lg">
          <Grid className="h-100" container spacing={12} alignItems="start" justifyContent="space-between">
            <Grid item xs={12} md={6} alignItems="center" justifyContent="center">
              ...
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSdXMi26prYUadSZlx_030qWwunLePidfyJhn8FJugvyHRWmsg/viewform"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLScn12b5CRRw38sDC6quwOkP8UGKB5ZSaH3rbqjFd49WqxWoZg/viewform"
                target="_blank"
                rel="noreferrer"
                style={{ textDecoration: "none" }}
              >
